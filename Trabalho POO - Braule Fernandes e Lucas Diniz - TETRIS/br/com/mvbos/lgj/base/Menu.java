...
public class Menu extends Texto {
	...
	public void desenha(Graphics2D g) {
		...
		g.setColor(getCor());
		super.desenha(g, String.format("TETRIS", getRotulo(), getPx(), getPy() + getAltura())); //ALTERAÇÃO DA TELA INICIAL

		if (selecionado)
			g.drawLine(getPx(), getPy() + getAltura()-13, getPx() + getLargura(), getPy() + getAltura()-13); //AJUSTAR A LINHA ABAIXO DO NOME TETRIS
